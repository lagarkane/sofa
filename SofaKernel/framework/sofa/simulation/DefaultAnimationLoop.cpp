...
void DefaultAnimationLoop::step(const core::ExecParams* params, SReal dt)
{
    ...
    sofa::helper::AdvancedTimer::stepBegin("UpdateDataFieldsVisitor");
    UpdateDataFieldsVisitor uid(params);
    gnode->execute ( uid );
    sofa::helper::AdvancedTimer::stepEnd("UpdateDataFieldsVisitor");
